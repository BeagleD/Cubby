(function() {
     ...
     *     curl http://104.236.60.113:8888/api/categories \
     ...
     *
     * @apiExample {curl} curl
     *     curl http://104.236.60.113:8888/api/customers/create \
	 *         -u sk_test_wCPyemzK7r6ZYaiRkEqzNvFN: \
     ...
     *
     * @apiExample {curl} curl
     *     curl http://104.236.60.113:8888/api/customers/cus_oC3ImnDw1Iqw1b3sx5CITtbc \
     *          -u sk_test_wCPyemzK7r6ZYaiRkEqzNvFN:
     *
     * @apiExample {curl} curl
     *     var ShareTempus = require('sharetempus')('sk_test_wCPyemzK7r6ZYaiRkEqzNvFN');
     ...
     *
     * @apiExample {curl} curl
     *     curl http://104.236.60.113:8888/api/policies/quote \
     *          -u sk_test_wCPyemzK7r6ZYaiRkEqzNvFN: \
     ...
     *
     * @apiExample {curl} curl
     *     curl http://104.236.60.113:8888/api/policies/create \
     *          -u sk_test_wCPyemzK7r6ZYaiRkEqzNvFN: \
     ...
     *
     * @apiExample {curl} curl
     *     curl http://104.236.60.113:8888/api/policies/pol_Re2UTmiZNd6hvn3eklRNOWET \
	 *         -u sk_test_wCPyemzK7r6ZYaiRkEqzNvFN:
     *
     * @apiExample {node} node
     *     var ShareTempus = require('sharetempus')('sk_test_wCPyemzK7r6ZYaiRkEqzNvFN');
